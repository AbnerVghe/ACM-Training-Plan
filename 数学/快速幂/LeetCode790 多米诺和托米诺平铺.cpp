...
public:
    int numTilings(int n) {
        ...
        if(n == 2) return 2;
        s start(1, 3);
        start.a[1][1] = 5, start.a[1][2] = 2, start.a[1][3] = 1;
        s mtx(3, 3);
        mtx.a[1][1] = 2;
        mtx.a[1][2] = mtx.a[2][3] = mtx.a[3][1] = 1;
        mtx.a[1][3] = mtx.a[2][1] = mtx.a[2][2] = mtx.a[3][2] = mtx.a[3][3] = 0;
        return (start * mtx.pow(n-3, MOD) % MOD).a[1][1];
    }
};